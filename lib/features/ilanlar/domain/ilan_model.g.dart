...
_IlanModel _$IlanModelFromJson(Map<String, dynamic> json) => _IlanModel(
  ...
  durum: json['durum'] as String? ?? IlanDurum.onayBekliyor,
  redSebebi: json['redSebebi'] as String? ?? '',
  ...
  sadeceGeliyorum: json['sadeceGeliyorum'] as bool? ?? false,
);
...
Map<String, dynamic> _$IlanModelToJson(_IlanModel instance) =>
    <String, dynamic>{
      ...
      'sadeceGeliyorum': instance.sadeceGeliyorum,
    };
