...
mixin _$IlanModel {
 ...
 String get id; String get tip; String get nereden; String get nereye; String get ucret; String get urun; String get notlar; String get kategori; String get kullaniciId; String get kullaniciAd; bool get aktif;@TimestampConverter() DateTime? get tarih;@TimestampConverter() DateTime? get olusturmaTarihi; String get resimUrl; List<String> get resimUrller; String get urunLinki; int get favoriSayisi; int get goruntulenmeSayisi; String get tasimaTercihi; double get kullaniciPuan; String get anaKategori; List<String> get kategoriYolu; String get cinsiyet; String get beden;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tip,nereden,nereye,ucret,urun,notlar,kategori,kullaniciId,kullaniciAd,aktif,tarih,olusturmaTarihi,resimUrl,const DeepCollectionEquality().hash(resimUrller),urunLinki,favoriSayisi,goruntulenmeSayisi,tasimaTercihi,kullaniciPuan,anaKategori,const DeepCollectionEquality().hash(kategoriYolu),cinsiyet,beden]);

@override
String toString() {
  return 'IlanModel(id: $id, tip: $tip, nereden: $nereden, nereye: $nereye, ucret: $ucret, urun: $urun, notlar: $notlar, kategori: $kategori, kullaniciId: $kullaniciId, kullaniciAd: $kullaniciAd, aktif: $aktif, tarih: $tarih, olusturmaTarihi: $olusturmaTarihi, resimUrl: $resimUrl, resimUrller: $resimUrller, urunLinki: $urunLinki, favoriSayisi: $favoriSayisi, goruntulenmeSayisi: $goruntulenmeSayisi, tasimaTercihi: $tasimaTercihi, kullaniciPuan: $kullaniciPuan, anaKategori: $anaKategori, kategoriYolu: $kategoriYolu, cinsiyet: $cinsiyet, beden: $beden)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tip,nereden,nereye,ucret,urun,notlar,kategori,kullaniciId,kullaniciAd,aktif,tarih,olusturmaTarihi,resimUrl,const DeepCollectionEquality().hash(_resimUrller),urunLinki,favoriSayisi,goruntulenmeSayisi,tasimaTercihi,kullaniciPuan,anaKategori,const DeepCollectionEquality().hash(_kategoriYolu),cinsiyet,beden]);
