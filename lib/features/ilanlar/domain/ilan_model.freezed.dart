...
mixin _$IlanModel {
 ...
 String get id; String get tip; String get nereden; String get nereye; String get ucret; String get urun; String get notlar; String get kategori; String get kullaniciId; String get kullaniciAd; bool get aktif;@TimestampConverter() DateTime? get tarih;@TimestampConverter() DateTime? get olusturmaTarihi; String get resimUrl; List<String> get resimUrller; String get urunLinki; int get favoriSayisi; String get tasimaTercihi; double get kullaniciPuan; String get anaKategori; List<String> get kategoriYolu;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tip,nereden,nereye,ucret,urun,notlar,kategori,kullaniciId,kullaniciAd,aktif,tarih,olusturmaTarihi,resimUrl,const DeepCollectionEquality().hash(resimUrller),urunLinki,favoriSayisi,tasimaTercihi,kullaniciPuan,anaKategori,const DeepCollectionEquality().hash(kategoriYolu)]);
