...
mixin _$SohbetModel {
 ...
 String get id; List<String> get kullanicilar; String get ilanId; String get ilanBaslik; String get ilanResimUrl; String get ilanSahibiId; String get ilanTip; String? get sonMesaj;@TimestampConverter() DateTime? get sonMesajZamani;@TimestampConverter() DateTime? get sonAktiviteZamani; String get sonGondereId; Map<String, int> get okunmamis; Map<String, dynamic> get gizli; Map<String, bool> get sabitlenmis; Map<String, String> get kullaniciAdlari; Map<String, dynamic> get islemDurumlari;
...
@useResult
$Res call({
 String id, List<String> kullanicilar, String ilanId, String ilanBaslik, String ilanResimUrl, String ilanSahibiId, String ilanTip, String? sonMesaj,@TimestampConverter() DateTime? sonMesajZamani,@TimestampConverter() DateTime? sonAktiviteZamani, String sonGondereId, Map<String, int> okunmamis, Map<String, dynamic> gizli, Map<String, bool> sabitlenmis, Map<String, String> kullaniciAdlari, Map<String, dynamic> islemDurumlari
});
...
/// Create a copy of SohbetModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? kullanicilar = null,Object? ilanId = null,Object? ilanBaslik = null,Object? ilanResimUrl = null,Object? ilanSahibiId = null,Object? ilanTip = null,Object? sonMesaj = freezed,Object? sonMesajZamani = freezed,Object? sonAktiviteZamani = freezed,Object? sonGondereId = null,Object? okunmamis = null,Object? gizli = null,Object? sabitlenmis = null,Object? kullaniciAdlari = null,Object? islemDurumlari = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as DateTime?,sonAktiviteZamani: freezed == sonAktiviteZamani ? _self.sonAktiviteZamani : sonAktiviteZamani // ignore: cast_nullable_to_non_nullable
...
as Map<String, String>,islemDurumlari: null == islemDurumlari ? _self.islemDurumlari : islemDurumlari // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  List<String> kullanicilar,  String ilanId,  String ilanBaslik,  String ilanResimUrl,  String ilanSahibiId,  String ilanTip,  String? sonMesaj, @TimestampConverter()  DateTime? sonMesajZamani, @TimestampConverter()  DateTime? sonAktiviteZamani,  String sonGondereId,  Map<String, int> okunmamis,  Map<String, dynamic> gizli,  Map<String, bool> sabitlenmis,  Map<String, String> kullaniciAdlari,  Map<String, dynamic> islemDurumlari)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SohbetModel() when $default != null:
return $default(_that.id,_that.kullanicilar,_that.ilanId,_that.ilanBaslik,_that.ilanResimUrl,_that.ilanSahibiId,_that.ilanTip,_that.sonMesaj,_that.sonMesajZamani,_that.sonAktiviteZamani,_that.sonGondereId,_that.okunmamis,_that.gizli,_that.sabitlenmis,_that.kullaniciAdlari,_that.islemDurumlari);case _:
  return orElse();
...
class _SohbetModel implements SohbetModel {
  const _SohbetModel({required this.id, required final  List<String> kullanicilar, required this.ilanId, this.ilanBaslik = '', this.ilanResimUrl = '', this.ilanSahibiId = '', this.ilanTip = 'istek', this.sonMesaj, @TimestampConverter() this.sonMesajZamani, @TimestampConverter() this.sonAktiviteZamani, this.sonGondereId = '', final  Map<String, int> okunmamis = const {}, final  Map<String, dynamic> gizli = const {}, final  Map<String, bool> sabitlenmis = const {}, final  Map<String, String> kullaniciAdlari = const {}, final  Map<String, dynamic> islemDurumlari = const {}}): _kullanicilar = kullanicilar,_okunmamis = okunmamis,_gizli = gizli,_sabitlenmis = sabitlenmis,_kullaniciAdlari = kullaniciAdlari,_islemDurumlari = islemDurumlari;
...
@override@TimestampConverter() final  DateTime? sonAktiviteZamani;
...
@override@JsonKey() Map<String, String> get kullaniciAdlari {
 ...
 final  Map<String, dynamic> _islemDurumlari;
@override@JsonKey() Map<String, dynamic> get islemDurumlari {
  if (_islemDurumlari is EqualUnmodifiableMapView) return _islemDurumlari;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_islemDurumlari);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SohbetModel&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other._kullanicilar, _kullanicilar)&&(identical(other.ilanId, ilanId) || other.ilanId == ilanId)&&(identical(other.ilanBaslik, ilanBaslik) || other.ilanBaslik == ilanBaslik)&&(identical(other.ilanResimUrl, ilanResimUrl) || other.ilanResimUrl == ilanResimUrl)&&(identical(other.ilanSahibiId, ilanSahibiId) || other.ilanSahibiId == ilanSahibiId)&&(identical(other.ilanTip, ilanTip) || other.ilanTip == ilanTip)&&(identical(other.sonMesaj, sonMesaj) || other.sonMesaj == sonMesaj)&&(identical(other.sonMesajZamani, sonMesajZamani) || other.sonMesajZamani == sonMesajZamani)&&(identical(other.sonAktiviteZamani, sonAktiviteZamani) || other.sonAktiviteZamani == sonAktiviteZamani)&&(identical(other.sonGondereId, sonGondereId) || other.sonGondereId == sonGondereId)&&const DeepCollectionEquality().equals(other._okunmamis, _okunmamis)&&const DeepCollectionEquality().equals(other._gizli, _gizli)&&const DeepCollectionEquality().equals(other._sabitlenmis, _sabitlenmis)&&const DeepCollectionEquality().equals(other._kullaniciAdlari, _kullaniciAdlari)&&const DeepCollectionEquality().equals(other._islemDurumlari, _islemDurumlari));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(_kullanicilar),ilanId,ilanBaslik,ilanResimUrl,ilanSahibiId,ilanTip,sonMesaj,sonMesajZamani,sonAktiviteZamani,sonGondereId,const DeepCollectionEquality().hash(_okunmamis),const DeepCollectionEquality().hash(_gizli),const DeepCollectionEquality().hash(_sabitlenmis),const DeepCollectionEquality().hash(_kullaniciAdlari),const DeepCollectionEquality().hash(_islemDurumlari));
...
/// Create a copy of SohbetModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? kullanicilar = null,Object? ilanId = null,Object? ilanBaslik = null,Object? ilanResimUrl = null,Object? ilanSahibiId = null,Object? ilanTip = null,Object? sonMesaj = freezed,Object? sonMesajZamani = freezed,Object? sonAktiviteZamani = freezed,Object? sonGondereId = null,Object? okunmamis = null,Object? gizli = null,Object? sabitlenmis = null,Object? kullaniciAdlari = null,Object? islemDurumlari = null,}) {
...
as Map<String, String>,islemDurumlari: null == islemDurumlari ? _self._islemDurumlari : islemDurumlari // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>,
  ));
}
